...
```{r}
#| label: fig-elbow
#| fig-cap: "Elbow plot — within-cluster sum of squares as a function of k. We use k=4 to mirror the four-tier RFM segmentation convention; the elbow on synthetic data lines up with that choice, on real data the curve is smoother and the choice is framework-driven."
...
We use **k = 4** to give a four-tier segmentation (R1–R4 / F1–F4 / M1–M4-style ranks). On synthetic data the bend lines up cleanly with k=4, on real data the choice is framework-driven (consistent four-tier story across BCG and RFM) rather than purely data-driven.
