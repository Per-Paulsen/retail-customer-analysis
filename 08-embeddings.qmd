...
group_lookup = df.drop_duplicates("article_id").set_index("article_id")["product_group"].to_dict()
...
for sku in ["L1001", "B3001", "D2001", "K9001", "U1001", "E6001"]:
    query(sku)
```
...
```{python}
#| label: fig-tsne
#| fig-cap: "t-SNE projection of the 66-SKU embeddings, colored by product group. Same-family SKUs cluster tightly; product groups form larger neighborhoods. The algorithm never saw the labels — it learned the structure from co-purchase context alone."
